...
var dba = dba || {};
	...
	// main query object
	module.exports.query = function(table,fields,values){
	...
	module.exports.readData = function(callback){
		...
		client.connect();	
				...
				if(this.fields == null)
				{
					var row= client.query("select * from "+this.table , function(err, result) {
	...
	/*db.prototype.init = function() {
	 ...
	 db.prototype.write = function(query){
		...
		client.connect();	
				...
				if(this.fields == null)
				{
					var row= client.query("insert into "+this.table + this.fields+" values ("+ this.values +")")
					
						//	var query54 = client.query("INSERT INTO \"po_lines\" VALUES('90','Meal Pack',5172,'Meal Pack',20,5,100,NULL,NULL,NULL)");
		
		row.on("end", function (result) {          
				console.log('Packing list LINES VALUE INSERTED');
			});
				}
